	...
	public static void main(String...args){
	   Scanner input = new Scanner(System.in);
		...
		for(int count = 0 ; count < forthStudent ; count++ ){
			...
			System.out.println("=================================================================================================");
			System.out.println("student 1" + "   " +" "+ firstStudentScore +" "+ subjectOneTotal +" 	"+ firstStudentOneAverage);
			System.out.println("student 2"+ "   "  +" "+ secondStudentScore +" "+ subjectTwoTotal +" 	"+ secondStudentAverage);
			System.out.println("student 3" + "   "  +" "+ thirdStudentScore +" "+ subjectThreeTotal +" 	"+ thirdStudentAverage);
			System.out.println("student 4" + "   "  +" "+ forthStudentScore +" "+ subjectFourTotal +" 	"+ forthStudentAverage);
			System.out.println("=================================================================================================");
			System.out.println("=================================================================================================");
